                    ...
                    <div className="relative mx-auto max-w-7xl">
                        ...
                        >
                            ...
                            <p className="mt-3 text-sm text-rose-900/45">
                                Three years. Twenty-six pictures. A million
                                little moments.
                            </p>
                        </motion.div>
                    ...
                    <div className="relative mx-auto max-w-6xl">
                        ...
                        >
                            ...
                            <p className="mt-5 text-base leading-7 text-pink-100/70 sm:text-lg">
                                You thought this was going to be a serious
                                birthday website?
                            </p>
                        ...
                        >
                            ...
                            <p className="mt-2 font-playfair text-2xl italic text-pink-300">
                                Don&apos;t worry. I have more embarrassing
                                things planned.
                            </p>
                        </motion.div>
                    ...
                    <div className="relative mx-auto max-w-6xl">
                        ...
                        >
                            ...
                            <p className="mt-6 text-base leading-7 text-rose-900/60 sm:text-lg">
                                Because honestly, there is no normal way to
                                describe you.
                            </p>
                        </motion.div>
                        ...
                        <div className="mt-16 flex justify-center">
                            <button
                                onClick={() => setRichiThingsCompleted(true)}
                                className="rounded-full bg-[#4a2635] px-8 py-4 text-sm font-medium text-white shadow-lg transition hover:scale-105"
                            >
                                Continue
                            </button>
                    ...
                    <div className="relative mx-auto max-w-5xl">
                        ...
                        >
                            ...
                            <p className="mt-6 text-base leading-7 text-rose-900/60 sm:text-lg">
                                ...
                                <br />
                                Just the little things that somehow stayed with
                                me.
                            </p>
                        </motion.div>
                        ...
                        <div className="mt-16 flex justify-center">
                            <button
                                onClick={() => setMemoriesCompleted(true)}
                                className="rounded-full bg-[#4a2635] px-8 py-4 text-sm font-medium text-white shadow-lg transition hover:scale-105"
                            >
                                Continue
                            </button>
                ...
                >
                    ...
                    <div className="relative mx-auto flex min-h-[80vh] max-w-5xl items-center justify-center">
                        ...
                        >
                            ...
                            <div className="mt-16 flex justify-center">
                                <button
                                    onClick={() => setMovieCompleted(true)}
                                    className="rounded-full bg-white px-8 py-4 text-sm font-medium text-[#4a2635] shadow-lg transition hover:scale-105"
                                >
                                    Continue
                                </button>
            ...
            {movieCompleted && (
                ...
                >
                    ...
                    <div className="relative mx-auto max-w-3xl text-center">
                        ...
                        <div className="mt-16 flex justify-center">
                            <button
                                onClick={() => setEmotionalCompleted(true)}
                                className="rounded-full bg-white px-8 py-4 text-sm font-medium text-[#4a2635] shadow-lg transition hover:scale-105"
                            >
                                Continue
                            </button>
                            ...
                            {!candlesBlown ? (
                                ...
                                >
                                    ...
                                    <p className="mt-4 text-xs text-[#9a7181]">
                                        Close your eyes first. Make a really
                                        good wish.
                                    </p>
                                </motion.div>
                            ) : (
                                ...
                                >
                                    ...
                                    <p className="mx-auto mt-4 max-w-lg text-sm leading-7 text-[#795666]">
                                        ...
                                        beautiful memories, and absolutely no
                                        shortage of chaos.
                                    </p>
