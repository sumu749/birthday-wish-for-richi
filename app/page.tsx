...
export default function Home() {
    ...
    const [richiThingsCompleted, setRichiThingsCompleted] = useState(false);
    const [memoriesCompleted, setMemoriesCompleted] = useState(false);
    const [movieCompleted, setMovieCompleted] = useState(false);
    const [emotionalCompleted, setEmotionalCompleted] = useState(false);
        ...
        <>
            {showIntro && (
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="fixed inset-0 z-9999 flex items-center justify-center bg-[#24151f]/95 px-6"
                >
                    <motion.div
                        ...
                        className="relative w-full max-w-md overflow-hidden rounded-3xl border border-rose-200/20 bg-[#fff7fa] px-6 py-12 text-center shadow-2xl md:px-10"
                    >
                        <div className="pointer-events-none absolute -right-20 -top-20 h-48 w-48 rounded-full bg-pink-200/50 blur-3xl" />
                        ...
                        <div className="relative z-10">
                            <motion.p
                                ...
                                className="text-xs font-medium uppercase tracking-[0.3em] text-rose-400"
                            >
                                A Secret Message
                            </motion.p>
                            ...
                            <motion.p
                                ...
                                className="mt-6 text-base leading-7 text-[#795666]"
                            >
                                Are you ready, energy biscuit?
                            </motion.p>

                            <div className="relative mx-auto mt-10 h-36 w-full max-w-xs">
                                <motion.button
                                    whileHover={{ scale: 1.06 }}
                                    whileTap={{ scale: 0.95 }}
                                    onClick={() => setShowIntro(false)}
                                    className="absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#4a2635] px-8 py-3 text-sm font-medium text-white shadow-lg transition-shadow hover:shadow-xl"
                                >
                                    YES
                                </motion.button>
                                ...
                                <motion.button
                                    ...
                                    className="absolute z-30 -translate-x-1/2 -translate-y-1/2 rounded-full border border-rose-200 bg-white px-7 py-3 text-sm font-medium text-[#795666] shadow-md"
                                >
                                    NO
                                </motion.button>
                            </div>
                            ...
                            <motion.p
                                ...
                                className="mt-5 text-xs italic text-rose-300"
                            >
                                Choose wisely...
                            </motion.p>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="font-medium text-rose-400">
                                    and somehow, you still haven&apos;t gotten
                                    rid of me.
                                </span>
                            </motion.p>
                            ...
                            <div className="relative mx-auto max-w-7xl">
                                ...
                                >
                                    ...
                                    <p className="mt-5 text-base leading-7 text-rose-900/65 sm:text-lg">
                                        Three years of friendship, countless
                                        memories, random conversations,
                                        laughter, and way too many pictures.
                                    </p>
                                ...
                                >
                                    ...
                                    <p className="mt-3 text-sm text-rose-900/45">
                                        Three years. Twenty-six pictures. A
                            ...
                            <div className="relative mx-auto max-w-6xl">
                                ...
                                >
                                    ...
                                    <p className="mt-5 text-base leading-7 text-pink-100/70 sm:text-lg">
                                        You thought this was going to be a
                                        serious birthday website?
                                    </p>
                                ...
                                >
                                    <p className="text-sm leading-6 text-pink-100/70">
                                        Because apparently saying “Happy
                                        Birthday” once wasn&apos;t enough. So
                                        here are some completely necessary
                                        birthday wishes.
                                    </p>

                                    <p className="mt-3 text-xs uppercase tracking-[0.25em] text-pink-300">
                                        Warning: May cause uncontrollable
                                        laughing
                                    </p>
                                </motion.div>
                            ...
                            <div className="relative mx-auto max-w-6xl">
                                ...
                                >
                                    ...
                                    <p className="mt-6 text-base leading-7 text-rose-900/60 sm:text-lg">
                                        Because honestly, there is no normal way
                                        to describe you.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    <p className="font-playfair text-2xl italic leading-relaxed text-rose-900/70 sm:text-3xl">
                                        “You&apos;re a little chaotic, a little
                                        dramatic, occasionally serious...”
                                    </p>
                            ...
                            <div className="relative mx-auto max-w-5xl">
                                ...
                                >
                                    ...
                                    <p className="mt-6 text-base leading-7 text-rose-900/60 sm:text-lg">
                                        ...
                                        <br />
                                        Just the little things that somehow
                                        stayed with me.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="font-playfair text-2xl italic leading-relaxed text-rose-900/70 sm:text-3xl">
                                        Maybe it&apos;s not the big moments that
                                    ...
                                    <div className="relative mx-auto max-w-4xl overflow-hidden rounded-4xl border border-pink-300/10 bg-linear-to-b from-rose-900/30 to-black p-5 shadow-2xl shadow-pink-950/30 sm:p-8 md:p-12 lg:p-16">
                                        ...
                                        <div className="relative text-center">
                                            ...
                                            <div className="mx-auto mt-12 flex max-w-xl flex-wrap items-center justify-center gap-x-8 gap-y-3 text-[10px] uppercase tracking-[0.2em] text-pink-200/50">
                                                <span>
                                                    {friendshipMovie.genre}
                                                </span>

                                                <span className="hidden h-1 w-1 rounded-full bg-pink-300/40 sm:block" />

                                                <span>
                                                    {friendshipMovie.duration}
                                                </span>

                                                <span className="hidden h-1 w-1 rounded-full bg-pink-300/40 sm:block" />

                                                <span>
                                                    {friendshipMovie.rating}
                                                </span>
                                            </div>
                    ...
                    {emotionalCompleted && (
                        ...
                        >
                            <div className="mx-auto max-w-4xl text-center">
                                ...
                                >
                                    Three years of friendship deserves a proper
                                    birthday cake. And yes, you actually have to
                                    ...
                                    {!candlesBlown ? (
                                        ...
                                        >
                                            ...
                                            <p className="mx-auto mt-4 max-w-lg text-sm leading-7 text-[#795666]">
                                                I hope this year brings you more
                                                laughter, more adventures, more
